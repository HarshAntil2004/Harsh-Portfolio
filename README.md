...
The photo is pulled directly from your GitHub avatar
(`profile.photoUrl` in `src/content/data.ts`, currently
`https://avatars.githubusercontent.com/u/276988065?v=4`) — update that field
if you change your GitHub avatar or want to point it at a different image
URL. If the image fails to load for any reason, it falls back to your
